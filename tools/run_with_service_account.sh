...
REPLICAS=`kubectl -n osh-system get deployment open4k -o jsonpath='{.spec.replicas}' || echo 0`
# if [ $REPLICAS -gt 0 ];
# then
...
# 	echo "kubectl -n osh-system scale deployment open4k --replicas 0"
# 	exit 1
# fi

SERVICE_ACCOUNT_NAME=open4k-account
...
kopf run --dev -n open4k -P open4k.instance --liveness=http://:8090/healthz $controllers
